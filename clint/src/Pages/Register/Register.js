  ...
  return (
    <div className='flex justify-center items-center h-screen bg-gradient-to-r from-violet-500 to-fuchsia-500'>
      <div className=' w-96 p-6 shadow-lg bg-stone-50 rounded-lg shadow-gray-500'>
        <h1 className='font-serifs text-xl font-bold text-center mb-5'>Create your Free Account</h1>
        <form onSubmit={formik.handleSubmit} className='flex  flex-col justify-center '>
          <div className='flex  flex-col justify-center mb-3'>
            ...
            {formik.touched.name && formik.errors.name ? (
              <div className='text-rose-600 pl-8 text-sm '>{formik.errors.name} </div>
            ) : null}
          </div>
          ...
          <div className='flex  flex-col justify-center mb-3'>
            <label className='font-serifs text-sm font-medium'> Password </label>
            <input
              className='rounded-xl p-1 ml-3 pl-3'
              type="password"
              name='password'
        ...
        <div className='font-serifs font-medium text-gray-500 flex justify-center mt-2'>
          <p > Have already an account?
            <a className='text-gray-900' href="/"> Login here</a>
          </p>
        </div>
      </div>
    </div>
